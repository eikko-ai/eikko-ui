...
export const Buttons = () => {
  ...
  return (
    <div className="h-screen bg-background dark:bg-background-dark">
      <div className="px-4 py-8 bg-background dark:bg-background-dark">
      ...
      <div className="p-8 flex space-x-2 flex-wrap">
      ...
      <div className="p-8">
        <Spinner size="xl" speed="fast" label="Loading" isCentered className="text-red-700" />
      </div>
      ...
      <div className="px-4 py-8 bg-background dark:bg-background-dark">
        <div className="max-w-3xl mx-auto space-y-4 flex flex-col items-center justify-start sm:space-y-0 sm:flex-row sm:items-end sm:justify-around">
          ...
          <Button
            ...
            size="xl"
            isRounded
            className="bg-green-600 text-green-100 shadow-lg"
          />
