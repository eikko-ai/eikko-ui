...
export type FormControlProps = FormControlContext & React.HTMLAttributes<HTMLElement>

export const FormControl = React.forwardRef((props: FormControlProps, ref: any) => {
  ...
  return (
    <FormControlContextProvider value={context}>
      <div role="group" ref={ref} className={_className} {...htmlProps} tw="w-full relative" />
